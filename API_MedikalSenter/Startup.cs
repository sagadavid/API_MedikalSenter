...
namespace API_MedikalSenter
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<Api_MedikalSenterContext>(options => 
                options.UseSqlite(Configuration
                .GetConnectionString("Api_MedikalSenterContext")));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                { Title = "API_MedikalSenter", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                ("/swagger/v1/swagger.json", "API_MedikalSenter v1"));
            }
